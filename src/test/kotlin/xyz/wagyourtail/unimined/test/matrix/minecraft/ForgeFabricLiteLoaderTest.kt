...
/**
 * Tests Forge + Legacy Fabric + LiteLoader
 *
 * @see ForgeTest
 * @see FabricMinecraftTest
 * @see ForgeFabricTest
 */
class ForgeFabricLiteLoaderTest : VersionMatrixTest {
	companion object {
		@JvmStatic
	...
	override val String.projectPath: String
		get() = "${this}-Forge-Fabric-LiteLoader"

	@ParameterizedTest(name = "[Gradle {0}] [Minecraft {1}]")
	@FieldSource("versions")
	fun test_forge_fabric_liteloader(gradleVersion: String, minecraftVersion: String) =
