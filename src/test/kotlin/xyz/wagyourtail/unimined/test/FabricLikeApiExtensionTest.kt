...
class FabricLikeApiExtensionTest {
	...
	@ParameterizedTest(name = "Full Fabric API {0}")
	@CsvSource(
		"0.100.8+1.21",
		"0.42.0+1.16",
		"0.28.5+1.14"
	...
	@ParameterizedTest(name = "Full Quilted Fabric API {0}")
	@CsvSource(
	...
	@ParameterizedTest(name = "Full Quilt Standard Libraries {0}")
	@CsvSource(
		"10.0.0-alpha.1+1.21",
	...
	@ParameterizedTest(name = "Quilt Standard Libraries {0} module {1}")
	@CsvSource(
	...
	@ParameterizedTest(name = "Full Legacy Fabric API {0}")
	@CsvSource(
		"1.10.2+1.6.4",
		"1.7.1+1.12.2",
		"1.0.0+1.8.9"
	...
	@ParameterizedTest(name = "Legacy Fabric API {0} module {1}")
	@CsvSource(
	...
	@ParameterizedTest(name = "Full StationAPI {0}")
	@CsvSource(
	...
	@ParameterizedTest(name = "Ornithe Standard Libraries {0} module {2} For MC {1}")
	@CsvSource(
	...
	@ParameterizedTest(name = "Ornithe Standard Libraries {0} module {3} For MC {1}-{2}")
	@CsvSource(
	...
	@ParameterizedTest(name = "Full Ornithe Standard Libraries {0} for MC {1}")
	...
	@ParameterizedTest(name = "Full Ornithe Standard Libraries {0} for MC {1}-{2}")
