...
class NeoForgeForgeFabric1_20_4Test {
    @ParameterizedTest
    @MethodSource("xyz.wagyourtail.unimined.util.IntegrationTestUtils#versions")
    fun test_neoforge_forge_fabric_1_20_4(gradleVersion: String) {
        try {
            val result = runTestProject("1.20.4-NeoForge-Forge-Fabric", gradleVersion)
