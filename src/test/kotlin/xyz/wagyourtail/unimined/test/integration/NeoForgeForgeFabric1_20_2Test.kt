...
class NeoForgeForgeFabric1_20_2Test {
    @ParameterizedTest
    @MethodSource("xyz.wagyourtail.unimined.util.IntegrationTestUtils#versions")
    fun test_neoforge_fabric_1_20_2(gradleVersion: String) {
        try {
            val result = runTestProject("1.20.2-NeoForge-Forge-Fabric", gradleVersion)
